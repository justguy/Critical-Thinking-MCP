...
function buildPrompt(
  ...
  const lines = [
    'Use `duckexperiments/AGENT_RUNNER_PROMPT.md` as the execution contract for one experiment cell.',
    '',
...
- In particular, do not edit \`duckexperiments/run_matrix.ts\`, \`duckexperiments/AGENT_RUNNER_PROMPT.md\`, or any source file.
...
function main(): void {
  ...
  const resultsRoot = resolve(repoRoot, config.resultsRoot ?? 'duckexperiments/results');
