...
This packet is the canonical human-audit companion to the Beta 2 release-gate benchmark in [`ct_beta2_ab_matrix_2026-04-10_release_gate_r2.md`](./ct_beta2_ab_matrix_2026-04-10_release_gate_r2.md).
...
- The machine artifact is in [`ct_beta2_ab_matrix_2026-04-10_release_gate_r2.json`](./ct_beta2_ab_matrix_2026-04-10_release_gate_r2.json).
- The benchmark contract that defines the expected safe-answer shape still lives in the repo docs at `docs/ct_mcp_beta2_benchmark.md`.
